Attribute VB_Name = "chang_month_filter81"
Sub chang_month_filter81_1()
On Error Resume Next
Sheets(36).Range("a9:cd8000").ClearContents
ActiveSheet.Range("a9: cd8000").UnMerge
...
For i = 1 To UBound(arr001, 1)
 ...
 If arr001(i, 81) <> UserForm28.TextBox2.Text Then
...
For frw1 = 9 To last1
 If Sheets(35).Cells(frw1, "cc") <> UserForm28.TextBox2.Text Then
