Attribute VB_Name = "thareaba_3kood"
Sub state_tax_akood()

On Error Resume Next

'ÇÓÊËäÇÁ ÇÍÊÓÇÈ ÇáÓãÇÍÇÊ ÇáÖÑíÈíå
...
If UserForm1.TextBox101.Text < 242500 Then
...
textvlue2 = UserForm1.TextBox101.Text
...
textvlue4 = UserForm1.TextBox101.Text
Dim rang3 As Range
Dim rang4 As Range
...
textvlue6 = UserForm1.TextBox101.Text
Dim rang5 As Range
Dim rang6 As Range
...
textvlue8 = UserForm1.TextBox101.Text
Dim rang7 As Range
Dim rang8 As Range
