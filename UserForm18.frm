...
lastR = Sheets(3).Cells(Rows.count, 1).End(xlUp).row
    ...
    End If
    Next Y
    Sheets(3).Cells(Y, 1) = TextBox1.Text
    Sheets(3).Cells(Y, 2) = TextBox2.Text
    Sheets(3).Cells(Y, 3) = TextBox3.Text
    Sheets(3).Cells(Y, 4) = TextBox4.value
    Sheets(3).Cells(Y, 5) = TextBox5.Text
    Sheets(3).Cells(Y, 6) = TextBox6.value
    Sheets(3).Cells(Y, 7) = TextBox7.Text
    Sheets(3).Cells(Y, 8) = TextBox8.Text
    Sheets(3).Cells(Y, 9) = TextBox9.Text
    Sheets(3).Cells(Y, 10) = TextBox10.Text
    Sheets(3).Cells(Y, 11) = TextBox11.Text
    Sheets(3).Cells(Y, 12) = TextBox12.Text
     Sheets(3).Cells(Y, 13) = TextBox13.value
    Sheets(3).Cells(Y, 14) = TextBox14.Text
    Sheets(3).Cells(Y, 15) = TextBox15.value
    Sheets(3).Cells(Y, 16) = TextBox16.Text
   Sheets(3).Cells(Y, 17) = TextBox17.value
    Sheets(3).Cells(Y, 18) = TextBox18.Text
    Sheets(3).Cells(Y, 19) = TextBox19.Text
    Sheets(3).Cells(Y, 20) = TextBox20.Text
    Sheets(3).Cells(Y, 21) = TextBox21.Text
    Sheets(3).Cells(Y, 22) = TextBox22.Text
    Sheets(3).Cells(Y, 23) = TextBox23.Text
    Sheets(3).Cells(Y, 24) = TextBox24.Text
    Sheets(3).Cells(Y, 25) = TextBox25.Text
   Sheets(3).Cells(Y, 26) = TextBox26.value
    Sheets(3).Cells(Y, 27) = TextBox27.Text
   Sheets(3).Cells(Y, 28) = TextBox28.value
  Sheets(3).Cells(Y, 29) = TextBox29.Text
    Sheets(3).Cells(Y, 30) = TextBox30.Text
    Sheets(3).Cells(Y, 31) = TextBox31.Text
  Sheets(3).Cells(Y, 32) = TextBox32.Text
   Sheets(3).Cells(Y, 33) = TextBox33.Text
    Sheets(3).Cells(Y, 34) = TextBox34.Text
    Sheets(3).Cells(Y, 35) = TextBox35.Text
    Sheets(3).Cells(Y, 36) = TextBox36.Text
    Sheets(3).Cells(Y, 37) = TextBox37.Text
    Sheets(3).Cells(Y, 38) = TextBox38.Text
    Sheets(3).Cells(Y, 39) = TextBox39.Text
    Sheets(3).Cells(Y, 40) = TextBox40.Text
    Sheets(3).Cells(Y, 41) = TextBox41.Text
    Sheets(3).Cells(Y, 42) = TextBox42.Text
    Sheets(3).Cells(Y, 43) = TextBox43.Text
    Sheets(3).Cells(Y, 44) = TextBox44.Text
    Sheets(3).Cells(Y, 45) = TextBox45.Text
    Sheets(3).Cells(Y, 46) = TextBox46.Text
    Sheets(3).Cells(Y, 47) = TextBox47.Text
  Sheets(3).Cells(Y, 48) = TextBox48.Text
   Sheets(3).Cells(Y, 49) = TextBox49.Text
   Sheets(3).Cells(Y, 50) = TextBox50.Text
   Sheets(3).Cells(Y, 51) = TextBox51.value
    Sheets(3).Cells(Y, 52) = TextBox52.Text
  Sheets(3).Cells(Y, 53) = TextBox53.Text
   Sheets(3).Cells(Y, 54) = TextBox54.Text
    Sheets(3).Cells(Y, 55) = TextBox55.Text
    Sheets(3).Cells(Y, 56) = TextBox56.Text
    Sheets(3).Cells(Y, 57) = TextBox57.Text
  Sheets(3).Cells(Y, 58) = TextBox58.Text
   Sheets(3).Cells(Y, 59) = TextBox59.Text
    Sheets(3).Cells(Y, 60) = TextBox60.Text
    Sheets(3).Cells(Y, 61) = TextBox61.Text
  Sheets(3).Cells(Y, 62) = TextBox62.Text
   Sheets(3).Cells(Y, 63) = TextBox63.Text
  Sheets(3).Cells(Y, 64) = TextBox64.Text
...
'   Sheets(3).Cells(y, 72) = TextBox88.Text
   Sheets(3).Cells(Y, 73) = TextBox64.Text
   Sheets(3).Cells(Y, 75) = TextBox81.Text
...
'=============================================
  ...
  If Sheets(3).Cells(frw1, "h") = TextBox67.Text And Sheets(3).Cells(frw1, "f") = ComboBox2.value And ComboBox3.Text = Sheets(3).Cells(frw1, "bf").value Then
...
item1.SubItems(58) = Sheets(3).Cells(frw1, "bg")
item1.SubItems(59) = Sheets(3).Cells(frw1, "bh")
item1.SubItems(60) = Sheets(3).Cells(frw1, "bi")
item1.SubItems(61) = Sheets(3).Cells(frw1, "bj")
item1.SubItems(62) = Sheets(3).Cells(frw1, "bk")
TextBox73.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("j9:j800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)
TextBox74.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("ad9:ad800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)
TextBox79.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("ae9:ae800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)
TextBox80.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("av9:av800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)
TextBox66.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("aw9:aw800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)
TextBox76.Text = Application.WorksheetFunction.SumIfs(Sheets(3).Range("x9:x800"), Sheets(3).Range("f9:f800"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("h9:h800"), "=" & Me.TextBox67.Text)


'=SUMIFS(J9:J571,F9:F571,BH12,H9:H571,BG12)
TextBox75.Text = Application.WorksheetFunction.CountIfs(Sheets(3).Range("h9:h571"), "=" & Me.TextBox67.Text, Sheets(3).Range("f9:f571"), "*" & Me.ComboBox2.Text & "*")
...
If ComboBox2.value = "«·ﬂ·" And Sheets(3).Cells(frw2, "bf") = ComboBox3.value Then

Set item2 = ListView1.ListItems.Add(, , Sheets(3).Cells(frw2, "A"))




item2.SubItems(1) = Sheets(3).Cells(frw2, "b")
item2.SubItems(2) = Sheets(3).Cells(frw2, "c")
item2.SubItems(3) = Sheets(3).Cells(frw2, "d")
item2.SubItems(4) = Sheets(3).Cells(frw2, "e")
item2.SubItems(5) = Sheets(3).Cells(frw2, "f")
item2.SubItems(6) = Sheets(3).Cells(frw2, "g")
item2.SubItems(7) = Sheets(3).Cells(frw2, "h")
item2.SubItems(8) = Sheets(3).Cells(frw2, "i")
item2.SubItems(9) = Sheets(3).Cells(frw2, "j")
item2.SubItems(10) = Sheets(3).Cells(frw2, "k")
item2.SubItems(11) = Sheets(3).Cells(frw2, "l")
item2.SubItems(12) = Sheets(3).Cells(frw2, "m")
item2.SubItems(13) = Sheets(3).Cells(frw2, "n")
item2.SubItems(14) = Sheets(3).Cells(frw2, "o")
item2.SubItems(15) = Sheets(3).Cells(frw2, "p")
item2.SubItems(16) = Sheets(3).Cells(frw2, "q")
item2.SubItems(17) = Sheets(3).Cells(frw2, "r")
item2.SubItems(18) = Sheets(3).Cells(frw2, "s")
item2.SubItems(19) = Sheets(3).Cells(frw2, "t")
item2.SubItems(20) = Sheets(3).Cells(frw2, "u")
item2.SubItems(21) = Sheets(3).Cells(frw2, "v")
item2.SubItems(22) = Sheets(3).Cells(frw2, "w")
item2.SubItems(23) = Sheets(3).Cells(frw2, "x")
item2.SubItems(24) = Sheets(3).Cells(frw2, "y")
item2.SubItems(25) = Sheets(3).Cells(frw2, "z")
item2.SubItems(26) = Sheets(3).Cells(frw2, "aa")
item2.SubItems(27) = Sheets(3).Cells(frw2, "ab")
item2.SubItems(28) = Sheets(3).Cells(frw2, "ac")
item2.SubItems(29) = Sheets(3).Cells(frw2, "ad")
item2.SubItems(30) = Sheets(3).Cells(frw2, "ae")
item2.SubItems(31) = Sheets(3).Cells(frw2, "af")
item2.SubItems(32) = Sheets(3).Cells(frw2, "ag")
item2.SubItems(33) = Sheets(3).Cells(frw2, "ah")
item2.SubItems(34) = Sheets(3).Cells(frw2, "ai")
item2.SubItems(35) = Sheets(3).Cells(frw2, "aj")
item2.SubItems(36) = Sheets(3).Cells(frw2, "ak")
item2.SubItems(37) = Sheets(3).Cells(frw2, "al")
item2.SubItems(38) = Sheets(3).Cells(frw2, "am")
item2.SubItems(39) = Sheets(3).Cells(frw2, "an")
item2.SubItems(40) = Sheets(3).Cells(frw2, "ao")
item2.SubItems(41) = Sheets(3).Cells(frw2, "ap")
item2.SubItems(42) = Sheets(3).Cells(frw2, "aq")
item2.SubItems(43) = Sheets(3).Cells(frw2, "ar")
item2.SubItems(44) = Sheets(3).Cells(frw2, "as")
item2.SubItems(45) = Sheets(3).Cells(frw2, "at")
item2.SubItems(46) = Sheets(3).Cells(frw2, "au")
item2.SubItems(47) = Sheets(3).Cells(frw2, "av")
item2.SubItems(48) = Sheets(3).Cells(frw2, "aw")
item2.SubItems(49) = Sheets(3).Cells(frw2, "ax")
item2.SubItems(50) = Sheets(3).Cells(frw2, "ay")
item2.SubItems(51) = Sheets(3).Cells(frw2, "az")
item2.SubItems(52) = Sheets(3).Cells(frw2, "ba")
item2.SubItems(53) = Sheets(3).Cells(frw2, "bb")
item2.SubItems(54) = Sheets(3).Cells(frw2, "bc")
item2.SubItems(55) = Sheets(3).Cells(frw2, "bd")
item2.SubItems(56) = Sheets(3).Cells(frw2, "be")
item2.SubItems(57) = Sheets(3).Cells(frw2, "bf")
item2.SubItems(58) = Sheets(3).Cells(frw2, "bg")
item2.SubItems(59) = Sheets(3).Cells(frw2, "bh")
item2.SubItems(60) = Sheets(3).Cells(frw2, "bi")
item2.SubItems(61) = Sheets(3).Cells(frw2, "bj")
item2.SubItems(62) = Sheets(3).Cells(frw2, "bk")
'item2.SubItems(63) = Sheets(3).Cells(frw2, "bl")
simadd = Application.WorksheetFunction.Sum(Sheets(3).Range("bh9:bh" & frw2))
simsubtract = Application.WorksheetFunction.Sum(Sheets(3).Range("bj9:bj" & frw2))
TextBox73.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("j9:j" & frw2))
TextBox74.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("ad9:ad" & frw2))
TextBox79.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("ae9:ae" & frw2))
TextBox80.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("av9:av" & frw2))
TextBox66.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("aw9:aw" & frw2))
TextBox76.Text = Application.WorksheetFunction.Sum(Sheets(3).Range("X9:X" & frw1))
TextBox67.Text = ""

TextBox66.Text = (TextBox66.Text + simadd) - simsubtract
'TextBox75.Text = Application.WorksheetFunction.Count(Sheets(3).Range("a9:a" & frw2))
...
ElseIf Sheets(3).Cells(frw1, "h") Like "*" & TextBox67.Text & "*" And Sheets(3).Cells(frw1, "f") Like "*" & ComboBox2.Text & "*" And ComboBox3.value = Sheets(3).Cells(frw1, "bf").value Then
  item2.SubItems(1) = Sheets(3).Cells(frw2, "b")
item2.SubItems(2) = Sheets(3).Cells(frw2, "c")
item2.SubItems(3) = Sheets(3).Cells(frw2, "d")
item2.SubItems(4) = Sheets(3).Cells(frw2, "e")
...
'TextBox75.Text = Application.WorksheetFunction.CountIfs(Sheets(3).Range("h9:h571"), "=" & Me.TextBox67.Text, Sheets(3).Range("f9:f571"), "*" & Me.ComboBox2.Text & "*", Sheets(3).Range("BF9:BF571"), "=" & Me.ComboBox3.Value)


'TextBox75.Text = Application.WorksheetFunction.CountIfs(Sheets(3).Range("BF9:BF" & frw2), "=" & Me.ComboBox3.Text)
TextBox75.Text = ListView1.ListItems.count
...
TextBox81.Text = Sheets(3).Cells(frw1, "bw")
Image1.Picture = LoadPicture(Sheets(3).Cells(frw1, 64))

'TextBox58Text = Sheets(3).Cells(frw1, "bg")
...
On Error GoTo emad
Sheets(3).Cells(3, 64) = TextBox65.Text
TextBox72.Text = Sheets(3).Cells(3, 65).Text
...
item1.SubItems(53) = Sheets(3).Cells(frw1, "bb")
item1.SubItems(54) = Sheets(3).Cells(frw1, "bc")
item1.SubItems(55) = Sheets(3).Cells(frw1, "bf")
...
item1.SubItems(61) = Sheets(3).Cells(frw1, "bj")
item1.SubItems(62) = Sheets(3).Cells(frw1, "bk")
item1.SubItems(74) = Sheets(3).Cells(frw1, "bw")
