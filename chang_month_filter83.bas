Attribute VB_Name = "chang_month_filter83"
Sub chang_month_filter83_1()
On Error Resume Next
Sheets(36).Range("a9:ce8000").ClearContents
ActiveSheet.Range("a9: ce8000").UnMerge
...
For i = 1 To UBound(arr001, 1)
 ...
 If arr001(i, 83) = UserForm28.TextBox2.Text Then
...
For frw1 = 9 To last1
 If Sheets(35).Cells(frw1, "ce") = UserForm28.TextBox2.Text Then
...
item1.SubItems(82) = Sheets(35).Cells(frw1, "ce")
