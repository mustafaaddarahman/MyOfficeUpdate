Attribute VB_Name = "all_tareaba_1"
Sub state_tax_22()
...
With UserForm48
If .TextBox23.Text = "ÇáÇÚÒÈ" Or .TextBox23.Text = "ÇáãØáŞ æáíÓ áÏíå ÍÖÇäÉ ááÃæáÇÏ" Or .TextBox23.Text = "ÇáãæÙİå ÇáãİÕæá ÏÎáåÇ Úä ÏÎá ÒæÌåÇ" Or .TextBox23.Text = "ÇáãæÙİ ÇáãÊÒæÌ æ ÒæÌÊå ÑÈÉ ÈíÊ" Or .TextBox23.Text = "ÇáãæÙİå ÇáãÊÒæÌå æÒæÌåÇ ÚÇØá Úãä ÇáÚãá" Then
...
On Error Resume Next
If .TextBox23.Text = "ÇáãæÙİÉ ãØáŞÉ" Or .TextBox23.Text = "ÇáãæÙİÉ ÇÑãáÉ" Then
...
On Error Resume Next
If .TextBox23.Text = "ÇáãæÙİÉ ãÊÒæÌÉ æÒæÌåÇ ÚÇÌÒ Úä ÇáÚãá" Then
...
On Error Resume Next
If .TextBox23.Text = "ÇáãæÙİ ÇáãØáŞ ÇĞÇ ßÇä ÍÇÖäÇ ááÃæáÇÏ" Or .TextBox23.Text = "ãÊæİÇÉ ÒæÌÊå" Or .TextBox23.Text = "ÇáãæÙİ ãÊÒæÌ æÏÎáå ãİÕæá Úä ÏÎá ÒæÌÊå" Then
