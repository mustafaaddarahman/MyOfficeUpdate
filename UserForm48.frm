VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm48 
   Caption         =   "UserForm48"
   ClientHeight    =   12372
   ClientLeft      =   120
   ClientTop       =   468
   ClientWidth     =   20172
   OleObjectBlob   =   "UserForm48.frx":0000
   RightToLeft     =   -1  'True
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "UserForm48"
...
TextBox10.Text = Sheets(9).Cells(18, "h")
Call mastmer_5dma_1
ElseIf CheckBox4.value = True And UserForm48.TextBox8.value < 8 _
And Sheets(1).Cells(nrow1, "b").value = TextBox2.Text And Sheets(1).Cells(nrow1, "e").value = TextBox5.Text Then
Sheets(1).Cells(nrow1, "cd") = "false"
Sheets(9).Cells(18, "g") = TextBox8.Text
Sheets(9).Cells(18, "f") = TextBox9.Text
...
ActiveCell.EntireRow.Delete
    ...
    Range("A" & iRow + 1).Offset(0, 3).value = TextBox49.value
    Range("A" & iRow + 1).Offset(0, 4).value = TextBox12.value & "·œÌÂ €Ì«» Êﬁœ—Â " & TextBox11.value
    Range("A" & iRow + 1).Offset(0, 5).value = TextBox31.value
    Range("A" & iRow + 1).Offset(0, 6).value = TextBox58.value
...
MsgBox "·„  ﬁ„ »«œŒ«·  «—ÌŒ «·‘Â— «·–Ì  „ «÷«› Â ··‰Ÿ«„", vbOKOnly, "—”«·…  ÊÃÌÂ"
...
Image2.Picture = LoadPicture(Sheets(1).Cells(frw2, 65))
ComboBox4.Text = Sheets(1).Cells(frw2, 4)
ComboBox5.Text = Sheets(1).Cells(frw2, 6)
ComboBox6.Text = Sheets(1).Cells(frw2, "m")
ComboBox7.Text = Sheets(1).Cells(frw2, "o")
ComboBox8.Text = Sheets(1).Cells(frw2, "q")
ComboBox9.Text = Sheets(1).Cells(frw2, "ay")
ComboBox10.Text = Sheets(1).Cells(frw2, "z")
ComboBox11.Text = Sheets(1).Cells(frw2, "ab")
ComboBox3.Text = Sheets(1).Cells(frw2, "bf")

TextBox82.Text = Format(Sheets(1).Cells(frw2, "bn"), "yyyy/mm/dd")

TextBox83.Text = Sheets(1).Cells(frw2, "bo")
TextBox84.Text = Sheets(1).Cells(frw2, "bp")
TextBox85.Text = Sheets(1).Cells(frw2, "bq")
TextBox86.Text = Sheets(1).Cells(frw2, "br")
TextBox87.Text = Sheets(1).Cells(frw2, "bs")
TextBox88.Text = Sheets(1).Cells(frw2, "bt")
TextBox91.Text = Sheets(1).Cells(frw2, "bv")
TextBox99.Text = Sheets(1).Cells(frw2, "bu")
TextBox100.Text = Sheets(1).Cells(frw2, "ca")
TextBox105.Text = Sheets(1).Cells(frw2, "ce")

CheckBox4.value = Sheets(1).Cells(frw2, "cd")

If TextBox58.Text = "⁄ﬁœ" Then
TextBox10.Enabled = False
Label123.Visible = True
TextBox10.Text = Sheets(1).Cells(frw2, "j")
TextBox10.Visible = False
TextBox101.Visible = True

TextBox101.Text = Sheets(1).Cells(frw2, "j")
