Attribute VB_Name = "delete_amployee_name1"
Sub delete_amployee_name()


On Error Resume Next
Sheets(39).Range("a9:bq8000").ClearContents
ActiveSheet.Range("92: bq60000").UnMerge
...
For i = 1 To UBound(arr001, 1)
 ...
 If arr001(i, 5) Like "*" & UserForm32.TextBox2.Text & "*" Then
...
Sheets(39).Range("a9").Resize(j, 69).value = arr002
...
For frw1 = 2 To last1
 If Sheets(3).Cells(frw1, "e") Like "*" & UserForm32.TextBox2.Text & "*" Then
