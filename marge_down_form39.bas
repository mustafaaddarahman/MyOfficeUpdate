Attribute VB_Name = "marge_down_form39"
Sub marge_down_form39_1()
...
al_mudeermalia = ""
al_mudeermassnaa = ""
UserForm39.TextBox4.value = Sheets(44).Cells(Rows.count, 1).End(xlUp).row + 4

'====================================================
Sheets(44).Range("a9  : " & "q" & UserForm39.TextBox4.value + 3).UnMerge
'Range("a9  : " & "br" & UserForm32.TextBox4.Value + 3).

'Sheets(39).Range("a9  : " & "br" & UserForm32.TextBox4.Value + 3).
'=================================
Sheets(44).Range("a" & UserForm39.TextBox4.value + 3 & " : " & "q" & UserForm39.TextBox4.value).Merge
...
al_mudeermalia = "„œÌ— «·„«·Ì  "
al_mudeermassnaa = "„œÌ— «·„’‰⁄"
Sheets(44).Range("a" & UserForm39.TextBox4.value + 3 & " : " & "q" & UserForm39.TextBox4.value).value = al_munatham & "                            " & al_muhaseb _
& "                         " & al_mudakek & "                         " & al_mudeerhesabat _
& "                            " & al_mudeermassnaa
Sheets(44).Range("a" & UserForm39.TextBox4.value + 3 & " : " & "q" & UserForm39.TextBox4.value).HorizontalAlignment = xlCenter
