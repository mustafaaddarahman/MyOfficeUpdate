VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm60 
   Caption         =   "UserForm60"
   ClientHeight    =   11070
   ClientLeft      =   120
   ClientTop       =   468
   ClientWidth     =   14052
   OleObjectBlob   =   "UserForm60.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "UserForm60"
...
On Error Resume Next
 Dim ws As Worksheet
    ...
    ' Ê—ﬁ… «·»Ì«‰«  «·√’·Ì…
    Set ws = ThisWorkbook.Sheets("emplmove")
...
Private Sub UserForm_Initialize()
 Dim ws As Worksheet
    ...
    Next i
     ...
     With Me.ComboBox3
        .AddItem " ﬁ—Ì— „ €Ì—«  «÷«›… «” Õﬁ«ﬁ"
        .AddItem " ﬁ—Ì— „ €Ì—«  Õ–› «” Õﬁ«ﬁ"
        .AddItem " ﬁ—Ì—  „ €Ì—«  Õ–› «” ﬁÿ«⁄"
        .AddItem " ﬁ—Ì—  €Ì—  ⁄œÌ· «” ﬁÿ«⁄ "
        .AddItem " ﬁ—Ì— «÷«›… „ÊŸ›Ì‰  "
        .AddItem " ﬁ—Ì— «·„‰ﬁÊ·Ì‰ Ê«·„Õ–Ê›Ì‰ "
...
Sub ExportReport(arr As Variant, colNums() As Long, reportName As String, deptName As String)
    ...
    For k = LBound(colNums) To UBound(colNums)
        headerArr(1, k + 1) = ThisWorkbook.Sheets("emplmove").Cells(1, colNums(k)).value
    Next k
