Attribute VB_Name = "filter_al_jaha"
Sub filter_aljha57()
On Error Resume Next
Sheets("sheet28").Range("a9:bv8000").ClearContents
ActiveSheet.Range("a9: bv6000").UnMerge
Dim arr1, arr2, lastR As Variant, i As Long, j As Long, k As Long
'Sheets(27).Range("a1:be200").ClearContents
lastR = Sheets(13).Cells(Rows.count, 1).End(xlUp).row
arr1 = Sheets(13).Range("a9:bv" & lastR)
j = 8
ReDim arr2(9 To UBound(arr1, 1), 1 To UBound(arr1, 2))

For i = 1 To UBound(arr1, 1)

 If arr1(i, 57) = UserForm17.TextBox2.Text Then
...
Sheets("sheet28").Range("a9").Resize(j - 1, 74).value = arr2
...
For frw1 = 9 To last1
 If Sheets(13).Cells(frw1, "be").value Like "*" & UserForm17.TextBox2.Text & "*" Then
