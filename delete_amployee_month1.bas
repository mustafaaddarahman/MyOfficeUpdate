Attribute VB_Name = "delete_amployee_month1"
Sub delete_amployee_month()
On Error Resume Next
Sheets(39).Range("a9:bq8000").ClearContents
ActiveSheet.Range("a9: bq6000").UnMerge
...
For i = 1 To UBound(arr001, 1)
 ...
 If arr001(i, 69) Like "*" & UserForm32.TextBox28.Text & "*" Then
