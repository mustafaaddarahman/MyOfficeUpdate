Attribute VB_Name = "case61_modyfay"
...
ActiveSheet.Range("a9: bz8000").UnMerge
...
For i = 1 To UBound(arr1, 1)
 ...
 If arr1(i, 61) Like "*" & UserForm17.TextBox2.Text & "*" Then
...
For frw1 = 9 To last1
 If Sheets(13).Cells(frw1, "bi").value Like "*" & UserForm17.TextBox2.Text & "*" Then
