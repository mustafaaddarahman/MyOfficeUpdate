Attribute VB_Name = "case_update_chang_salary002"
Sub case_update_chang_salary1()
...
For i = 1 To UBound(arr001, 1)
 ...
 If arr001(i, 5) Like "*" & UserForm28.TextBox2.Text & "*" Then
...
For frw1 = 9 To last1
 If Sheets(35).Cells(frw1, "e") Like "*" & UserForm28.TextBox2.Text & "*" Then
