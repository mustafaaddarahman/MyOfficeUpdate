...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm2 
   Caption         =   "ÇáİÆÜÜÜÜÜÜÜÜÜÜÜÜÜÜÇÊ ÇáæÙÜÜÜÜÜÜÜÜÜÜÜíİíå"
   ClientHeight    =   11532
   ClientLeft      =   48
   ClientTop       =   396
   ClientWidth     =   18048
...
Next frw2
End With
Me.TextBox72.value = ListView2.ListItems.count
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "n") >= TextBox1.Text Then
...
End With
 ...
 Me.TextBox10.value = ListView1.ListItems.count
...
'Or Sheets(1).Cells(frw2, "p") >= TextBox2.Text Then
'Or Sheets(1).Cells(frw2, "r") >= TextBox3.Text Or Sheets(1).Cells(frw2, "s") >= TextBox4.Text Or Sheets(1).Cells(frw2, "t") >= TextBox4.Text _
'Or Sheets(1).Cells(frw2, "u") >= TextBox6.Text Or Sheets(1).Cells(frw2, "j") >= TextBox7.Text Or Sheets(1).Cells(frw2, "aa") >= TextBox8.Text _
'Or Sheets(1).Cells(frw2, "ac") >= TextBox9.Text Or Sheets(1).Cells(frw2, "y") >= TextBox68.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
'Me.TextBox10.Value = ListView1.ListItems.Count
'Me.TextBox11.Value = ListView1.ListItems.Count
End If
Next frw2
End With
TextBox10.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("n9:n571"), ">=" & Me.TextBox1.Text)
TextBox11.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("p9:p571"), ">=" & Me.TextBox2.Text)
TextBox12.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("r9:r571"), ">=" & Me.TextBox3.Text)
TextBox13.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("s9:s571"), ">=" & Me.TextBox4.Text)
TextBox14.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("t9:t571"), ">=" & Me.TextBox5.Text)
TextBox15.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("u9:u571"), ">=" & Me.TextBox6.Text)
TextBox16.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("j9:j571"), ">=" & Me.TextBox7.Text)
TextBox17.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("aa9:aa571"), ">=" & Me.TextBox8.Text)
TextBox18.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("ac9:ac571"), ">=" & Me.TextBox9.Text)
 TextBox69.Text = Application.WorksheetFunction.CountIfs(Sheets(1).Range("f9:f571"), "*" & Me.ComboBox1.Text & "*", Sheets(1).Range("ac9:ac571"), ">=" & Me.TextBox68.Text)
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox3.value And Sheets(1).Cells(frw2, "x") >= val(TextBox19.Text) Then
Set item2 = ListView2.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Next frw2
End With
Me.TextBox30.value = ListView2.ListItems.count
End Sub
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "p") >= TextBox2.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Next frw2
End With
Me.TextBox32.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox31.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox33.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox34.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox35.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox36.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox64.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox65.value = ListView2.ListItems.count
...
Next frw2
End With
Me.TextBox67.value = ListView2.ListItems.count
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "r") >= TextBox3.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Me.TextBox12.value = ListView1.ListItems.count
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "s") >= TextBox4.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Me.TextBox13.value = ListView1.ListItems.count
...
Next frw2
End With
Me.TextBox14.value = ListView1.ListItems.count
...
Me.TextBox15.value = ListView1.ListItems.count
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "y") >= TextBox68.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Me.TextBox69.value = ListView1.ListItems.count
...
Me.TextBox16.value = ListView1.ListItems.count
...
Next frw2
End With
Me.TextBox71.value = ListView2.ListItems.count
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "aa") >= TextBox8.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
last2 = Sheets(1).Range("A" & Rows.count).End(xlUp).row
For frw2 = 9 To last2
If Sheets(1).Cells(frw2, "f") = Me.ComboBox1.value And Sheets(1).Cells(frw2, "ac") >= TextBox9.Text Then
Set item2 = ListView1.ListItems.Add(, , Sheets(1).Cells(frw2, "A"))
'==================================================
item2.SubItems(1) = Sheets(1).Cells(frw2, "b")
item2.SubItems(4) = Sheets(1).Cells(frw2, "e")
...
Next frw2
End With
Me.TextBox18.value = ListView1.ListItems.count
...
.ColumnHeaders.Add , , " ÌåÉ ÇáÇÓÊŞØÇÚ ", 0
.ColumnHeaders.Add , , " äÇÏí ÇáåíÃÉ ÇáÕäÇÚÇÊ ÇáÍÑÈí", 120
.ColumnHeaders.Add , , "ÌåÉ ÇáÇÓÊŞØÇÚ ", 0
.ColumnHeaders.Add , , "ÇÓÊŞØÇÚ 2 ", 140
.ColumnHeaders.Add , , "ÌåÉ ÇáÇÓÊŞØÇÚ 2 ", 0
.ColumnHeaders.Add , , "ÇÓÊŞØÇÚÇÊ ÑÚÇíå", 0
