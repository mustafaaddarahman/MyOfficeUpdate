Attribute VB_Name = "case_listbox"
Sub case_listbox()
On Error Resume Next
Dim i1 As Integer
For i1 = 0 To ListBox1.ListCount - 1
If UserForm17.ListBox1.Selected(i1) Then
UserForm17.ListBox1.Text = i1
...
Sheets("sheet28").Range("a9").Resize(j, UBound(arr2, 2)) = arr2
...
For frw1 = 9 To last1
 If Sheets(13).Cells(frw1, "j").value = CDbl(UserForm17.TextBox2.Text) Then
