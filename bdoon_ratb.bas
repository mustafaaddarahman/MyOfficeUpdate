Attribute VB_Name = "bdoon_ratb"
Sub bdoon_ratb1_22()

If UserForm1.TextBox58.Text = "«Ã«“… »œÊ‰ —« »" Then
...
'userform1.textbox33.Text =
'userform1.textbox34.Text
'userform1.textbox35.Text
'userform1.textbox36.Text
'userform1.textbox38.Text
'userform1.textbox39.Text
'userform1.textbox40.Text
'userform1.textbox42.Text
'userform1.textbox44.Text
'userform1.textbox46.Text


'„Ã„Ê⁄ «·«” ﬁÿ«⁄« 
UserForm1.TextBox48.value = 0
...
'===============«·«” ﬁÿ«⁄« 
UserForm1.TextBox48.Text = 0

'=======================

'==================== „»·€ «·€Ì«»
UserForm1.TextBox49.Text = 0
