Attribute VB_Name = "marge_down_form53"

Sub marge_down_form53_1()
...
al_mudeermalia = ""
al_mudeermassnaa = ""
UserForm17.TextBox4.value = Sheets(53).Cells(Rows.count, 1).End(xlUp).row + 4

'====================================================
Sheets(53).Range("a9  : " & "q" & UserForm17.TextBox4.value + 3).UnMerge
'Range("a9  : " & "br" & UserForm32.TextBox4.Value + 3).

'Sheets(39).Range("a9  : " & "br" & UserForm32.TextBox4.Value + 3).
'=================================
Sheets(53).Range("a" & UserForm17.TextBox4.value + 3 & " : " & "q" & UserForm17.TextBox4.value).Merge
...
al_mudeermalia = "„œÌ— «·„«·Ì  "
al_mudeermassnaa = "„œÌ— «·„’‰⁄"
Sheets(53).Range("a" & UserForm17.TextBox4.value + 3 & " : " & "q" & UserForm17.TextBox4.value).value = al_munatham & "                            " & al_muhaseb _
& "                         " & al_mudakek & "                         " & al_mudeerhesabat _
& "                            " & al_mudeermassnaa
Sheets(53).Range("a" & UserForm17.TextBox4.value + 3 & " : " & "q" & UserForm17.TextBox4.value).HorizontalAlignment = xlCenter
