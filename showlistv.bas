...
item1.SubItems(70) = Sheets(13).Cells(frw1, "br")
item1.SubItems(71) = Sheets(13).Cells(frw1, "bs")
item1.SubItems(72) = Sheets(13).Cells(frw1, "bt")
item1.SubItems(73) = Sheets(13).Cells(frw1, "bu")
item1.SubItems(74) = Sheets(13).Cells(frw1, "bv")
