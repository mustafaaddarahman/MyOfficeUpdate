...
' , "ca", "cb", "cc", "cd")
For c = 1 To 69
If Sheets(3).Cells(1, c).value = Me.ComboBox1.value Then
...
Call vba_border_sheet_39_1
Call sum_report_32_1
UserForm38.Show
End Sub
...
Sheets(39).Range("a:bq").EntireColumn.Hidden = True
End Sub

Private Sub CommandButton4_Click()
On Error Resume Next
Sheets(39).Range(TextBox25.Text & ":" & TextBox25.Text).EntireColumn.Hidden = False

End Sub

Private Sub CommandButton5_Click()
On Error Resume Next
Sheets(3).Range(TextBox25.Text & ":" & TextBox25.Text).EntireColumn.Hidden = True
End Sub

Private Sub CommandButton6_Click()
Sheets(39).Range(TextBox25.Text & ":" & TextBox25.Text).EntireColumn.Hidden = True
End Sub
...
Range("a:bq").EntireColumn.Hidden = True
Sheets(39).Range(TextBox5.Text & ":" & TextBox5.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox6.Text & ":" & TextBox6.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox7.Text & ":" & TextBox7.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox8.Text & ":" & TextBox8.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox9.Text & ":" & TextBox9.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox10.Text & ":" & TextBox10.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox11.Text & ":" & TextBox11.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox12.Text & ":" & TextBox12.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox13.Text & ":" & TextBox13.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox14.Text & ":" & TextBox14.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox15.Text & ":" & TextBox15.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox16.Text & ":" & TextBox16.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox17.Text & ":" & TextBox17.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox18.Text & ":" & TextBox18.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox19.Text & ":" & TextBox19.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox20.Text & ":" & TextBox20.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox21.Text & ":" & TextBox21.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox22.Text & ":" & TextBox22.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox23.Text & ":" & TextBox23.Text).EntireColumn.Hidden = False
Sheets(39).Range(TextBox24.Text & ":" & TextBox24.Text).EntireColumn.Hidden = False
...
Range("a:bv").EntireColumn.Hidden = False
ListBox1.Clear
TextBox5.Text = ""
TextBox6.Text = ""
TextBox7.Text = ""
...
item1.SubItems(3) = Sheets(3).Cells(frw1, "n")
...
item1.SubItems(3) = Sheets(3).Cells(frw1, "ag")
...
'item1.SubItems(63) = Sheets(3).Cells(frw1, "bl")
'item1.SubItems(64) = Sheets(3).Cells(frw1, "bm")
'item1.SubItems(65) = Sheets(3).Cells(frw1, "bn")
'item1.SubItems(66) = Sheets(3).Cells(frw1, "bo")
'item1.SubItems(67) = Sheets(3).Cells(frw1, "bp")
...
For i = 1 To 69
Me.ComboBox1.AddItem Sheets(3).Cells(1, i).value
