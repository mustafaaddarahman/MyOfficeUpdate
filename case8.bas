...
For i = 9 To UBound(arr1, 1)

 If arr1(i, 8) = CDbl(UserForm17.TextBox2.Text) Then
...
For frw1 = 9 To last1
 If Sheets(13).Cells(frw1, "h").value = CDbl(UserForm17.TextBox2.Text) Then
